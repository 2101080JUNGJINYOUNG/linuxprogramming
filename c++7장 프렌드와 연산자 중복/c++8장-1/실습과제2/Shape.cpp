...
void Circle::show(){                                                                     // Circle 멤버함수 정의
    cout << "좌표 (" << x <<"," << y << ")에 반지름"<< radius << "인 원" << endl;         // radius를 화면에 출력해준다
}
...
void Rect::show(){                                                                                         // Rect 멤버함수 정의
    cout << "좌표 (" << x <<"," << y << ")에 폭"<< width << ", 높이" << height << "인 직사각형"<<endl;       // width, height를 화면에 출력해준다
}
...
void Triangle::show(){                                                                                      // Triangle 멤버함수 정의
    cout << "좌표 (" << x <<"," << y << ")에 밑변"<< width << ", 높이" << height << "인 삼각형"<<endl;        // width와 height를 화면에 출력해준다.
}
