...
class Color;                                               // 클래스 Color 선언
Color operator+(Color op1, Color op2);                     // 전역함수 선언
bool operator==(Color op1, Color op2);                     // 전역함수 선언
...
public:
    ...
    void show();                                            // 멤버 함수 선언    
    friend Color operator+(Color op1, Color op2);           // friend 함수 선언
    friend bool operator==(Color op1, Color op2);           // friend 함수 선언
};
